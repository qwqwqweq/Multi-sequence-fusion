...
class DualPathway3DResNeSt(nn.Module):
...
def ResNeSt3D18Fusion(num_classes=3, radix=2):
    return DualPathway3DResNeSt(layers=(2,2,2,2), radix=radix, num_classes=num_classes)

def ResNeSt3D50Fusion(num_classes=3, radix=2):
    return DualPathway3DResNeSt(layers=(3,4,6,3), radix=radix, num_classes=num_classes)
