...
class DualPathway3DMobileNetV2(nn.Module):
...
def MobileNetV2_3D_Fusion(num_classes=3, width_mult=1.0):
    return DualPathway3DMobileNetV2(num_classes=num_classes, width_mult=width_mult)
